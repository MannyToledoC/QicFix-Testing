...
//        return respuesta;
    	...
    	listOfUsers.get(0).setEmail("123@gmail.com");
    	listOfUsers.get(0).setPassword("password123");
    	
    	listOfUsers.get(1).setEmail("AUser@gmail.com");
    	listOfUsers.get(1).setPassword("123");
    	
    	listOfUsers.get(2).setEmail("JohnDoe@gmail.com");
    	listOfUsers.get(2).setPassword("12345678");
...
//
    	...
    	listOfUsers.get(0).setEmail("123@gmail.com");
    	listOfUsers.get(0).setPassword("password123");
    	listOfUsers.get(0).setFname("Derrick");
    	listOfUsers.get(0).setLname("Mcdermott");
    	listOfUsers.get(0).setUserTypeId(1);
    	listOfUsers.get(0).setStreetAddress("245 Fairway Street");
    	listOfUsers.get(0).setCity("Apple Valley");
    	listOfUsers.get(0).setState("CA");
    	listOfUsers.get(0).setZipcode("92307");
    	listOfUsers.get(0).setDob(new Date(456789));
    	listOfUsers.get(0).setPhone("5552226666");
    	
    	listOfUsers.get(1).setEmail("AUser@gmail.com");
    	listOfUsers.get(1).setPassword("123");
    	listOfUsers.get(1).setFname("Hawa");
    	listOfUsers.get(1).setLname("Hutchinson");
    	listOfUsers.get(1).setUserTypeId(2);
    	listOfUsers.get(1).setStreetAddress("85 Mill Pond St.");
    	listOfUsers.get(1).setCity("Eden Prairie");
    	listOfUsers.get(1).setState("MN");
    	listOfUsers.get(1).setZipcode("55347");
    	listOfUsers.get(1).setDob(new Date(456753));
    	listOfUsers.get(1).setPhone("4442225555");
    	
    	listOfUsers.get(2).setEmail("JohnDoe@gmail.com");
    	listOfUsers.get(2).setPassword("12345678");
    	listOfUsers.get(2).setFname("John");
    	listOfUsers.get(2).setLname("Doe");
    	listOfUsers.get(2).setUserTypeId(3);
    	listOfUsers.get(2).setStreetAddress("7826 Mill Ave.");
    	listOfUsers.get(2).setCity("Lawrence Township");
    	listOfUsers.get(2).setState("NJ");
    	listOfUsers.get(2).setZipcode("08648");
    	listOfUsers.get(2).setDob(new Date(241262));
    	listOfUsers.get(2).setPhone("3332224444");
